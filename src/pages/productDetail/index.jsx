            ...
            <div className="basis-1/2">
              <div className="mt-5 md:mt-16">
                ...
                <div className="flex flex-wrap border-b items-center gap-3 py-3 pb-6">
                  ...
                  <span>/</span>
                  <span className="text-[11px] md:text-[13px]">1 Reviews</span>
                  <span>/</span>
                ...
                <div className="text-gray-500 mt-5">
                  ...
                  <div className="mt-2 flex gap-2">
                    <label
                      htmlFor="128gb"
                      className={` cursor-pointer p-2 border rounded-md inline-block`}
                    >
                      <input
                        defaultValue={"128gb"}
                        type="radio"
                ...
                <div className="text-gray-500 my-5">
                  <div>
                    Color :
                    <span className="font-bold text-black capitalize"></span>
                  </div>
                  <div className="mt-2 flex gap-2">
                    {colors &&
                      colors.map((item) => (
                        <label
                          ...
                          key={item.id}
                          htmlFor={item.name}
                          className={` cursor-pointer p-2 border rounded-full w-8 h-8 inline-block`}
                        >
                          <input
                ...
                <div className="border-b py-4">
                  <div className="flex flex-col  gap-2 text-gray-500">
                    ...
                    <p className="flex gap-2 my-3 text-gray-500">
                      ...
                      Return within 30 days of purchase. Taxes are
                      non-refundable.
                    </p>
                  </div>
                </div>
